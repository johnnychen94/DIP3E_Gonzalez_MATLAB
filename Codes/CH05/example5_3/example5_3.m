...
med_0 = sp_cktb;
med_1 = nlfilter(med_0,[mask_size,mask_size],median_filter);
med_2 = nlfilter(med_1,[mask_size,mask_size],median_filter);
med_3 = nlfilter(med_2,[mask_size,mask_size],median_filter);
...
function dest_intensity = alpha_mean(window,d)
    d = floor(d/2);
    sorted_intensities = sort(window(:));
