...
BC(1:end-1,:)= CC(2:end,:);
BR = double(image_data(X_inverse_pixel_int,Y_inverse_pixel_int));
BR(1:end-1,1:end-1) = CC(2:end,2:end);
CR = double(image_data(X_inverse_pixel_int,Y_inverse_pixel_int));
CR(:,1:end-1) = CC(:,2:end);
